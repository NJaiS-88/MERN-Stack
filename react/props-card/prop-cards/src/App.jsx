...
function App() {
  ...
  const jobOpenings = [
    ...
    {
      brandLogo: "https://th.bing.com/th/id/OIP.aoNGSVIqKHtM-NWf3QrvdwHaHa?w=160&h=180&c=7&r=0&o=7&dpr=2&pid=1.7&rm=3",
      companyName: "Google",
  ...
  return (
    <div className="parent-div">
      {jobOpenings.map((ele, index)=>{
        return <div id={index}>
          <Card logo={ele.brandLogo} name={ele.companyName} date={ele.datePosted} location={ele.location} tag1={ele.tag1} tag2={ele.tag2} price={ele.pay} post={ele.post} />
        </div>
      })}
    </div>
  )
